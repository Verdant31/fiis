...
export default function MinimalFiisList({
  fiis,
  isLoading,
}: MiniimalFiisListProps) {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      ...
                      {fiiPercent !== 0 && (
                        <span
                          className={`${fiiPercent > 0 ? 'text-green-500' : 'text-red-600'} ml-2`}
                        >
                          {fiiPercent > 0 && '+'}
                          {fiiPercent}%
                        </span>
