      ...
      <DialogContent className="focus-visible:outline-none min-h-[300px] sm:max-w-[600px]">
        <div className="flex flex-col">
          ...
          <div className="grid  grid-cols-3 gap-6  p-4">
            <div>
              <h1 className="inline-block tracking-wider  font-medium text-[#adfa1d] bg-opacity-70 ">
                Quote
              </h1>
              <h1 className="mt-2 text-xl font-regular tracking-wide">
                {BRL.format(purchases[0].quotationValue)}
              </h1>
            </div>
            <div>
              <h1 className="inline-block tracking-wider  font-medium text-[#adfa1d] bg-opacity-70 ">
                ...
                {payments?.map((payment) => {
                  return (
                    <TableRow key={payment.id}>
                      ...
                      <TableCell>
                        {payment.quotesQuantityAtThePayment}
                      </TableCell>
                      <TableCell>
                        {BRL.format(
                          payment.quotesQuantityAtThePayment *
                            payment.paidPerQuote,
                        )}
                      </TableCell>
